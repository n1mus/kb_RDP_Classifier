...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_RDP_Classifier'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_RDP_Classifier.kb_RDP_ClassifierImpl import kb_RDP_Classifier  # noqa @IgnorePep8
impl_kb_RDP_Classifier = kb_RDP_Classifier(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_RDP_Classifier'
